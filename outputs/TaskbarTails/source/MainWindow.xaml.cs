...
public partial class MainWindow : Window
{
    ...
    public MainWindow(App owner)
    {
        ...
        NameBox.Text = app.State.Name; SpeciesBox.SelectedIndex = app.State.Species == "rabbit" ? 1 : 0;
    ...
    public void Refresh()
    {
        ...
        Preview.Species = s.Species; Preview.Sleeping = s.Sleeping; Preview.ShowName = false;
    ...
    void Apply_Click(object sender, RoutedEventArgs e)
    {
        ...
        app.State.Name = name; app.State.Species = SpeciesBox.SelectedIndex == 1 ? "rabbit" : "cat";
