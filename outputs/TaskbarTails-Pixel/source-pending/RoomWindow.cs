...
public sealed class RoomWindow:Window
{
 ...
 {
  app=owner;Title="Taskbar Tails · 함께하는 방";Width=490;Height=560;MinHeight=480;WindowStartupLocation=WindowStartupLocation.CenterOwner;
